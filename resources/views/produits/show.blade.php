<x-layout :titre="$carte->nom" css="css/customs/index.css">
    <x-header/>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                        <div class="col-10 col-sm-8 col-lg-6">
                            ...
                            <img src="{{ asset($carte->imagePath ?? 'images/produits/image-non-disponible.jpg')}}" class="d-block mx-lg-auto img-fluid"
